...
These examples are synthetic. They are designed to show shape, not to represent real papers, private logs, or real experiments.
...
Use these files to understand the expected records before connecting private ResearchKB data.
